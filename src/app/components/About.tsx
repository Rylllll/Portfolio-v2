...
export const About = () => {
  ...
  return (
    <section
      id="AboutMe"
      ref={containerRef}
      className="w-full min-h-screen px-6 md:px-10 py-24 md:py-32 flex flex-col justify-center bg-[#1E1E1E] dark:bg-black text-white border-b-[4px] border-black dark:border-white relative overflow-clip transition-colors"
    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 gap-8 w-full">
          <div className="flex flex-col">
            ...
            <div className="relative uppercase">
              <h2
                className="absolute top-2 left-2 text-[60px] md:text-[80px] lg:text-[110px] font-display leading-[0.8] tracking-tight whitespace-nowrap text-transparent opacity-30 [-webkit-text-stroke:2px_white]"
              >
                ABOUT ME
              </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          <div className="w-full lg:w-[55%] flex flex-col justify-center">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="mt-6 text-sm md:text-base text-gray-300 font-medium max-w-md leading-relaxed border-l-[3px] border-[#A3F1B6] pl-4"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
              <motion.div
                ...
                className="bg-[#2a2a2a] dark:bg-zinc-900 p-5 rounded-[24px] border-[2px] border-white transition-all group"
              >
              ...
              <motion.div
                ...
                className="col-span-1 sm:col-span-2 bg-[#2a2a2a] dark:bg-zinc-900 p-5 rounded-[24px] border-[2px] border-white transition-all group flex flex-col sm:flex-row items-center sm:items-start gap-4"
              >
          ...
          <div className="w-full lg:w-[45%] relative h-[400px] lg:h-[500px] flex items-center justify-center hidden md:flex">
            <motion.div className="relative w-full max-w-[400px] aspect-[4/5] bg-[#F4EFE6] dark:bg-zinc-800 rounded-[32px] border-[4px] border-white overflow-hidden shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] group">
              <ImageWithFallback
